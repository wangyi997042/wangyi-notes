// @ts-nocheck
/**
 * Base on https://github.com/umijs//Users/wangwang/Documents/开发/全/前端/xue/react/umi-learn/node_modules/.pnpm/umi-request@1.4.0/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/Users/wangwang/Documents/开发/全/前端/xue/react/umi-learn/node_modules/.pnpm/umi-request@1.4.0/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/Users/wangwang/Documents/开发/全/前端/xue/react/umi-learn/node_modules/.pnpm/@ahooksjs+use-request@2.8.15_react@17.0.2/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/Users/wangwang/Documents/开发/全/前端/xue/react/umi-learn/node_modules/.pnpm/@ahooksjs+use-request@2.8.15_react@17.0.2/node_modules/@ahooksjs/use-request/lib/types';

type ResultWithData<T = any> = { content?: T; [key: string]: any };
...
function useRequest<R extends ResultWithData = any, P extends any[] = any>(
  service: CombineService<R, P>,
  options?: BaseOptions<R['content'], P>,
): BaseResult<R['content'], P>;
...
function useRequest<
  ...
  RR extends R = any,
>(
  service: CombineService<R, LoadMoreParams<R['content']>>,
  options: LoadMoreOptions<RR['content']>,
): LoadMoreResult<R['content']>;
...
function useRequest(service: any, options: any = {}) {
  return useUmiRequest(service, {
    formatResult: result => result?.content,
